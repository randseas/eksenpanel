...
export default function AdminEditRedirect() {
  ...
  useEffect(() => {
    ...
    setIsRedirectActive(findedRedirect?.status);
    setDestinationURL(findedRedirect?.destinationUrl || "");
    setTitle(findedRedirect?.title || "");
    setDescription(findedRedirect?.description || "");
    setRedirectCode(findedRedirect?.jsUrl || "");
  }, [redirectId]);
